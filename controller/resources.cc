...
static constexpr char str_res_waveform[] PROGMEM = "waveform";
static constexpr char str_res_parameter[] PROGMEM = "parameter";
static constexpr char str_res_range[] PROGMEM = "range";
static constexpr char str_res_tune[] PROGMEM = "tune";
static constexpr char str_res_osc_mix[] PROGMEM = "osc mix";
static constexpr char str_res_sub_osc_[] PROGMEM = "sub osc.";
static constexpr char str_res_crossmod_[] PROGMEM = "crossmod.";
static constexpr char str_res_operator[] PROGMEM = "operator";
static constexpr char str_res_amount[] PROGMEM = "amount";
static constexpr char str_res_resonance[] PROGMEM = "resonance";
...
static constexpr char str_res_release[] PROGMEM = "release";
static constexpr char str_res_trigger[] PROGMEM = "trigger";
static constexpr char str_res_rate[] PROGMEM = "rate";
static constexpr char str_res_lfo_eg[] PROGMEM = "lfo/eg";
static constexpr char str_res_voice_lfo[] PROGMEM = "voice lfo";
static constexpr char str_res_source[] PROGMEM = "source";
static constexpr char str_res_destination[] PROGMEM = "destination";
static constexpr char str_res_in1[] PROGMEM = "in1";
static constexpr char str_res_in2[] PROGMEM = "in2";
static constexpr char str_res_modulation[] PROGMEM = "modulation";
static constexpr char str_res_modul_[] PROGMEM = "modul.";
static constexpr char str_res_modifier[] PROGMEM = "modifier";
static constexpr char str_res_modif_[] PROGMEM = "modif.";
static constexpr char str_res_volume[] PROGMEM = "volume";
static constexpr char str_res_octave[] PROGMEM = "octave";
static constexpr char str_res_spread[] PROGMEM = "spread";
static constexpr char str_res_legato[] PROGMEM = "legato";
static constexpr char str_res_portamento[] PROGMEM = "portamento";
static constexpr char str_res_arp_seq[] PROGMEM = "arp/seq";
static constexpr char str_res_raga[] PROGMEM = "raga";
static constexpr char str_res_direction[] PROGMEM = "direction";
static constexpr char str_res_pattern[] PROGMEM = "pattern";
static constexpr char str_res_channel[] PROGMEM = "channel";
static constexpr char str_res_part[] PROGMEM = "part";
static constexpr char str_res_bpm[] PROGMEM = "bpm";
static constexpr char str_res_ltch[] PROGMEM = "ltch";
static constexpr char str_res_latch[] PROGMEM = "latch";
static constexpr char str_res_low[] PROGMEM = "low";
static constexpr char str_res_high[] PROGMEM = "high";
static constexpr char str_res_grid[] PROGMEM = "grid";
static constexpr char str_res_seq1_len[] PROGMEM = "seq1 len";
static constexpr char str_res_seq2_len[] PROGMEM = "seq2 len";
static constexpr char str_res_patt_len[] PROGMEM = "patt len";
static constexpr char str_res_len1[] PROGMEM = "len1";
static constexpr char str_res_len2[] PROGMEM = "len2";
static constexpr char str_res_lenp[] PROGMEM = "lenp";
static constexpr char str_res_groove[] PROGMEM = "groove";
static constexpr char str_res_midi[] PROGMEM = "midi";
static constexpr char str_res_snap[] PROGMEM = "snap";
static constexpr char str_res_help[] PROGMEM = "help";
